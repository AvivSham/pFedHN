...
from experiments.hetro.models import DNNHyper, DNNTargetLook, CNNHyper, CNNTargetLook
...
def train(data_name: str, data_path: str, num_nodes: int, steps: int, optim: str,
    ...
    if data_name == "mnist":
        hnet = DNNHyper(num_nodes, embedding_dim=embed_dim, hidden_dim=args.hyper_hid)
        net = DNNTargetLook()
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--data-name", type=str, default="cifar10", choices=['mnist', 'cifar10', 'cifar100'], help="dir path for MNIST dataset"
    )
